...
export function buildPomodoroSummary(coefficient, totalMinutes) {
  const times = calculatePomodoroTimes(coefficient, totalMinutes)
  return {
    study_time: times.studyTime,
    rest_time: times.restTime,
    cycles: times.cycles,
    remaining: times.remainingTime,
